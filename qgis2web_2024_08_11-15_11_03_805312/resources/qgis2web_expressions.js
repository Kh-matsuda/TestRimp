...
function exp_LTC_StationTMTCcopy_3rule0_eval_expression(context) {
    ...
    if (feature.properties) {
        return ((feature.get('Label_Func')  == 'Master Station') || ((feature.get('Label_Func')  == 'TM') && (feature.get('TM_HW.')  !== 1)));
    } else {
        return ((feature.get('Label_Func')  == 'Master Station') || ((feature.get('Label_Func')  == 'TM') && (feature.get('TM_HW.')  !== 1)));
    }
}
...
function exp_LTC_StationTMTCcopy_3rule1_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Controllin')  == 'SPC');
    } else {
        return (feature.get('Controllin')  == 'SPC');
    }
}
...
function exp_LTC_StationTMTCcopy_3rule2_eval_expression(context) {
    ...
    if (feature.properties) {
        return ((feature.get('Controllin')  == 'TC') || (feature.get('Label_Func')  == 'Master Station'));
    } else {
        return ((feature.get('Controllin')  == 'TC') || (feature.get('Label_Func')  == 'Master Station'));
    }
}